...
public class PressStat {
	...
	public String toString() {
		...
		int[] counts = new int[] {count50, count90, count99, count999, count9999};
		String[] percentStrs = new String[]{"PERCENT 50.00", "PERCENT 90.00", "PERCENT 99.00", "PERCENT 99.90", "PERCENT 99.99"};
		int index = 0;
